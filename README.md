...
This code is currently optimized for the **AMD Radeon 8060S (Strix Halo)** using the specialized **ROCm/TheRock** nightly builds. While the original project targeted NVIDIA H100s, this fork demonstrates that integrated APUs with unified memory can achieve high-performance LLM training.

Seeing as there seems to be a lot of interest in tinkering with autoresearch on various compute platforms, a few extra words. If you're going to try running autoresearch on other hardware, I'd recommend one of the forks below.
